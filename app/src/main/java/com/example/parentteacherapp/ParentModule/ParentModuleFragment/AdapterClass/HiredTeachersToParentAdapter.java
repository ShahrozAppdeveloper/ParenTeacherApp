...
public class HiredTeachersToParentAdapter extends RecyclerView.Adapter<HiredTeachersToParentAdapter.Viewholder> {
    ArrayList<ShowTeacherDetails> datalist;
    Context context;

    public HiredTeachersToParentAdapter(ArrayList<ShowTeacherDetails> datalist, Context context) {
    ...
    public Viewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View photoView
                = inflater
                .inflate(R.layout.hired_teacher_layout,
                        parent, false);
